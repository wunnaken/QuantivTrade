...
const DEFAULT_NOTES: Omit<DevNote, "id" | "timestamp">[] = [
  ...
  { type: "info", title: "Custom price alerts not built yet", description: "Planned feature — users set price targets and get notified. Needs Finnhub websocket + Firebase push notifications.", page: "planned" },
