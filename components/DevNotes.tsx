...
const DEFAULT_NOTES: Omit<DevNote, "id" | "timestamp">[] = [
  ...
  { type: "info", title: "Price Alerts", description: "Price alerts now save to Supabase price_alerts table. localStorage used as fallback only. Alert triggering via Finnhub WebSocket updates alert status in Supabase when condition is met.", page: "/watchlist" },
  ...
  { type: "info", title: "Trade Journal", description: "Trades now save to Supabase trades table. localStorage used as fallback only. Open trade unrealized P&L uses Finnhub real-time prices via WebSocket.", page: "/journal" },
