...
function VerifyTwoFactorForm() {
  ...
  useEffect(() => {
    if (!factorId) router.replace("/auth/sign-in");
  }, [factorId, router]);
      ...
      <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-6 py-10">
        ...
        <div className="mb-6 text-center">
          <div className="mb-4 flex justify-center">
            <div className="flex h-12 w-12 items-center justify-center rounded-full border border-white/10 bg-white/5">
              <svg className="h-6 w-6 text-zinc-300" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden>
        ...
        >
          <div className="space-y-1 text-xs">
            <label className="block text-zinc-300" htmlFor="totp-code">
              Authenticator code
            </label>
            <input
              id="totp-code"
