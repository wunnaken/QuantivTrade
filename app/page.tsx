...
export default function Home() {
  ...
  const showWelcome = !!user && !hasBeenWelcomed() && !welcomeDone;
  ...
  return (
    <>
      ...
      <main className="mx-auto flex max-w-6xl flex-col gap-16 px-6 py-16 lg:flex-row lg:items-center lg:gap-20 lg:px-8 lg:py-24">
        <section className="flex-1 space-y-8">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <Link
              href="/auth/sign-up"
              className="rounded-full bg-[var(--accent-color)] px-6 py-2.5 text-sm font-semibold text-[#020308] shadow-xl shadow-[var(--accent-color)]/40 transition hover:bg-[var(--accent-color)]"
            >
              Join Xchange
            </Link>
            <Link
              href="/news"
              className="rounded-full border border-white/15 px-5 py-2 text-sm font-medium text-zinc-200 transition hover:border-[var(--accent-color)]/60 hover:text-[var(--accent-color)]"
            >
        ...
        <section className="flex-1">
          <div className="relative rounded-3xl border border-white/5 bg-gradient-to-br from-slate-900 via-slate-950 to-black p-6 shadow-2xl shadow-black/60">
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Link
                href="/map"
                className="space-y-3 rounded-2xl border border-white/5 bg-white/5 p-4 backdrop-blur transition hover:border-[var(--accent-color)]/30"
              >
              ...
              <Link
                href="/mission"
                className="pulse-logo-link group flex min-h-[7.5rem] flex-col items-center justify-center gap-2 md:min-h-0"
                aria-label="View Xchange mission"
              >
      ...
      {/* Who it's for + perks — catchy description */}
      ...
      {/* Features — dark greyish-blue section: text stays light and visible */}
      <section className="dark-bg-section border-t border-white/5 bg-[#050713]">
        <div className="mx-auto max-w-6xl px-6 py-14 lg:px-8 lg:py-16">
          <div className="mb-10 flex flex-col gap-3 md:flex-row md:items-end md:justify-between">
            <div>
              <h2 className="text-xl font-semibold text-zinc-100 sm:text-2xl">
                Built for how modern markets move.
              </h2>
              <p className="mt-2 max-w-xl text-sm text-zinc-300">
                From social communities to real-time news and growth tools,
                Xchange connects global flows, narratives, and portfolios in one
                interface.
              </p>
            </div>
          </div>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Link
              href="/communities"
              className="group rounded-2xl border border-white/5 bg-gradient-to-b from-white/5 to-white/[0.01] p-5 transition hover:border-[var(--accent-color)]/60 hover:shadow-[0_0_40px_var(--accent-color-40)] cursor-pointer"
            >
              <div className="mb-4 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-[var(--accent-color)]/15 text-[var(--accent-color)]">
              ...
              <p className="mt-2 text-sm text-zinc-300">
                Join focused rooms for equities, FX, crypto, macro, and more —
                curated by signal, not noise.
              </p>
              <p className="mt-3 text-xs text-emerald-300/80 group-hover:text-[var(--accent-color)]">
                Threads, live chats, and curated idea streams by strategy.
              </p>
            </Link>
            ...
            <Link
              ...
              className="group rounded-2xl border border-white/5 bg-gradient-to-b from-white/5 to-white/[0.01] p-5 transition hover:border-[var(--accent-color)]/60 hover:shadow-[0_0_40px_var(--accent-color-40)] cursor-pointer"
            >
              <div className="mb-4 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-cyan-500/15 text-cyan-300">
                <span className="text-lg">📰</span>
              </div>
              <h3 className="text-sm font-semibold text-zinc-100">
                Real-time News
              ...
              <p className="mt-2 text-sm text-zinc-300">
                Current market news and global updates. Choose your topics and
                regions — we surface what matters to you.
              </p>
              <p className="mt-3 text-xs text-cyan-300/80 group-hover:text-[var(--accent-color)]">
                Select what you want to follow. More coming soon.
              </p>
            </Link>
            ...
            <Link
              ...
              className="group rounded-2xl border border-white/5 bg-gradient-to-b from-white/5 to-white/[0.01] p-5 transition hover:border-[var(--accent-color)]/60 hover:shadow-[0_0_40px_var(--accent-color-40)] cursor-pointer"
            >
              <div className="mb-4 inline-flex h-9 w-9 items-center justify-center rounded-xl bg-fuchsia-500/15 text-fuchsia-300">
                <span className="text-lg">📈</span>
              </div>
              <h3 className="text-sm font-semibold text-zinc-100">
                Growth Profiles
              ...
              <p className="mt-2 text-sm text-zinc-300">
                Explore passive, moderate, and high-risk paths tailored to your
                time horizon.
              </p>
              <p className="mt-3 text-xs text-fuchsia-300/80 group-hover:text-[var(--accent-color)]">
                Click to view profile breakdowns and risk explanations.
              </p>
            </Link>
          </div>
        </div>
      ...
      {/* Bottom CTA — dark greyish-blue section: text stays light and visible */}
      <section className="dark-bg-section border-t border-white/5 bg-[#050713]">
        <div className="mx-auto max-w-4xl px-6 py-12 text-center lg:px-8 lg:py-16">
          ...
          <p className="mt-3 text-sm text-zinc-300 sm:text-base">
            Join traders, investors, and macro thinkers from around the world.
            One interface for ideas, risk, and execution.
          </p>
          <div className="mt-6 flex justify-center">
            <Link
              href="/onboarding"
              className="rounded-full bg-[var(--accent-color)] px-7 py-2.5 text-sm font-semibold text-[#020308] shadow-xl shadow-[var(--accent-color)]/40 transition hover:bg-[var(--accent-color)]"
            >
